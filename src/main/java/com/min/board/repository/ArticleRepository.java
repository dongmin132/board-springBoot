...
import com.min.board.repository.querydsl.ArticleRepositoryCustom;
...
{
    Page<Article> findByTitleContaining(String title, Pageable pageable);       //Containing : 부분 검색이 가능하도록
